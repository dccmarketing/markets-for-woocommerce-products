 ...
 */
 ...
 var project = {
	'zipfile' : 'markets-for-woocommerce-products.zip',
	'url': 'tcci.dev',
	'i18n': {
		'domain': 'markets-for-woocommerce-products',
		'destFile': 'markets-for-woocommerce-products.pot',
...
gulp.task( 'styles', function () {
	gulp.src( watch.styles )
		...
		.pipe( plugins.sourcemaps.write ( './assets/css/', { includeContent: false } ) )
